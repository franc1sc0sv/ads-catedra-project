...
Desde el detalle de un pedido en SOLICITADO el encargado también puede marcarlo como ENVIADO para reflejar que ya fue remitido al proveedor y está en tránsito. Esta acción no mueve stock —el stock solo cambia al recibir— pero permite registrar la progresión real del pedido. Un pedido ENVIADO ya no puede editarse ni cancelarse; si algo falla antes de que llegue, el encargado lo recibe con cantidades en cero como evidencia, o crea un pedido nuevo.
