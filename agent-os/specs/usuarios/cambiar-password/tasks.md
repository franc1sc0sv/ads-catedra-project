...
- [ ] **Task 2: Extend `UsuarioServiceInterface` and `UsuarioService`**
...
- [ ] **Task 3: Create `ChangePasswordRequest` (self-change)**
...
- [ ] **Task 4: Create `ResetPasswordRequest` (admin reset)**
...
- [ ] **Task 6: Wire routes in `routes/web.php`**
...
- [ ] **Task 8: Bind interface in `AppServiceProvider`**
