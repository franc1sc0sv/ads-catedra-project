<nav class="bg-neutralDark shadow-md" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center gap-3">
                ...
                <span class="bg-accent text-neutralDark text-xs font-semibold px-2 py-0.5 rounded-full">Inventory</span>
            </div>
    ...
    <div x-show="open" class="md:hidden bg-neutralDark/95 px-4 pb-3">
