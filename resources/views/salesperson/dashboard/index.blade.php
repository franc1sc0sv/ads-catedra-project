...
@section('nav')
    <x-nav.salesperson-nav />
@endsection

@section('content')
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900">Sales Dashboard</h1>
        <p class="text-gray-500 text-sm mt-1">Track your sales and manage customer orders.</p>
    </div>
